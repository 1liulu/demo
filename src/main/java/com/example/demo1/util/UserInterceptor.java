...
public class UserInterceptor implements HandlerInterceptor {
    ...
    private static final String urlMatcher1 = "\\S*(wx/user|wxindex/user|Patient/list|Patient/addPatient|Patient/particulars|Patient/reportDetails|Patient/specialistfinall|Consultation/list|authorization/addAuthorization|authorization/list|authorization/overduelist)S*$";
