...
public class SpecialistController {
    ...
    public Map specialistParticulars(String id){
    ...
    public Map addSpecialist(String phone,String name){
    ...
    public Map updateSpecialist(String name,String phone,String id){
        if (StringUtils.isBlank(phone)) {
            return MsgBuilder.buildReturnErrorMessage("请输入手机号");
        }
        if (StringUtils.isBlank(name)) {
